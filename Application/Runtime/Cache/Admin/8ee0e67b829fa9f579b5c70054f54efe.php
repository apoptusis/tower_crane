            ...
            <div class="well">
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tower-form">
                            <label>塔机编号</label>
                            <input type="text" class="input-xlarge" value="<?php echo ($data["crane_id"]); ?>" name="crane_id">
                            <label>塔机类型</label>
                            <select name="type" id="" class="input-xlarge" style="width: 285px">
                                <option value="">请选择塔机类型</option>
                                <option value="塔头式塔机" <?php if($data["type"] == '塔头式塔机'): ?>selected="selected"<?php endif; ?> >塔头式塔机</option>
                                <option value="平头式塔机" <?php if($data["type"] == '平头式塔机'): ?>selected="selected"<?php endif; ?> >平头式塔机</option>
                                <option value="动臂式塔机" <?php if($data["type"] == '动臂式塔机'): ?>selected="selected"<?php endif; ?> >动臂式塔机</option>
                            </select>
                            <label>塔机型号</label>
                            <input type="text" class="input-xlarge" value="<?php echo ($data["model"]); ?>" name="model">
                            <label>SIM卡号</label>
                            <input type="text" class="input-xlarge" value="<?php echo ($data["sim_num"]); ?>" name="sim_num">
                            <label>终端号</label>
                            <input type="text" class="input-xlarge" value="<?php echo ($data["term_num"]); ?>" name="term_num">
                            <label>备注</label>
                            <textarea value="Smith" rows="3" class="input-xlarge" name="remarks"><?php echo ($data["remarks"]); ?></textarea>
                            <input type="hidden" value="<?php echo ($data["id"]); ?>" name="id">
                            <div>
                                <button id="button-submit" type="button" class="btn btn-primary">修改</button>
