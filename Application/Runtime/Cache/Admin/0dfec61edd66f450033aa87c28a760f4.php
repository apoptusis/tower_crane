  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        <div class="navbar-inner">
                ...
                <a class="brand" href="../index/index.html"><span class="first">江麓</span> <span class="second">塔机监控系统</span></a>
        </div>
    </div>
    ...
    <div class="dialog">
        <div class="block">
            ...
            <div class="block-body">
                <form id="tower-form">
                    <label>用户名</label>
                    <input type="text" name="username" class="span12" placeholder="请输入用户名">
                    <label>密码</label>
                    <input type="password" name="password" class="span12" placeholder="请输入密码">
                    <button id="button-submit" type="button" class="btn btn-primary pull-right">登录</button>
                    <label class="remember-me"><input name="remember" type="checkbox" value="1">记住我</label>
                    <div class="clearfix"></div>
                </form>
            </div>
        </div>
        <p class="pull-right"><a href="<?php echo U('Admin/Login/forget');?>">忘记密码?</a></p>
    </div>
</div>
    ...
    <script src="/tower_crane/Public/js/admin/login.js"></script>
    <script src="/tower_crane/Public/lib/bootstrap/js/bootstrap.js"></script>


    <script>
        var SCOPE = {
            'post_url' : "<?php echo U('Admin/Login/Login');?>",
            'jump_url' : "<?php echo U('Admin/Index/index');?>",
        }
    </script>
