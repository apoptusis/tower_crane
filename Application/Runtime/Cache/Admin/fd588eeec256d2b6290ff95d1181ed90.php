            ...
            <div class="well">
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tower-form">
                            <label>塔机编号</label>
                            <input type="text" class="input-xlarge" placeholder="请输入塔机编号" name="craneID">
                            <label>塔机类型</label>
                            <select name="type" id="" class="input-xlarge" style="width: 285px">
                                <option value="">请选择塔机类型</option>
                                <option value="1">塔头式塔机</option>
                                <option value="2">平头式塔机</option>
                                <option value="3">动臂式塔机</option>
                            </select>
                            <label>塔机型号</label>
                            <input type="text" class="input-xlarge" placeholder="请输入塔机型号" name="model">
                            <label>SIM卡号</label>
                            <input type="text" class="input-xlarge" placeholder="请输入SIM卡号" name="simNum">
                            <label>终端号</label>
                            <input type="text" class="input-xlarge" placeholder="请输入终端号" name="termNum">
                            <label>备注</label>
