...
<div class="btn-toolbar">
    <form id="tower-form" enctype="multipart/form-data" method="post" action="<?php echo U('Admin/UserExcel/import');?>">
    ...
    <table class="table table-hover" >
      ...
      <?php $i=1 ?>
        <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
                ...
                <td>
                    <a href="/tower_crane/index.php/Admin/User/userEdit/id/<?php echo ($list["id"]); ?>"><i class="icon-pencil"></i></a>
...
<script>
    var SCOPE = {
        ...
        'changeStatus_url' : "<?php echo U('Admin/User/userBan');?>",
        'export_url' : "<?php echo U('Admin/UserExcel/export');?>",
